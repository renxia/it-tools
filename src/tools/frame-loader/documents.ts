...
export const Docs = [
  defineTool({
    path: '/quant-wiki',
    name: translate('tools.quant-wiki.title', [], '中文量化百科'),
    description: translate(
      'tools.quant-wiki.description',
      [],
      '开源的中文量化百科，由LLMQuant社区整理, 收录了133+量化金融所需的基础知识概念。',
    ),
    keywords: ['IT', '手册', '阅读', '备忘录', '速查'],
    component: () => import('./frame-loader.vue'),
    icon: MilitaryTechSharp,
    config: {
      remoteUrl: 'https://lzw.me/doc/quant-wiki/',
      hideHeader: true,
    },
