...
<template>
  <div class="mb-50px mt-50px">
    <div class="grid-wrapper mx-auto max-w-1400px">
      <h3 class="mb-35px mt-5px text-center font-size-50px font-900 text-neutral-800">
        {{ title }}
      </h3>
      <div class="wd:grid-cols-6 grid grid-cols-1 gap-6px md:gap-10px lg:gap-12px lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 xl:grid-cols-4">
